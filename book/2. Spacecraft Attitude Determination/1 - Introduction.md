...
2) **Динамическое определение ориентации** 
   ...
   В этом случае измерения поступают в течение некоторого промежутка времени. Для объединения разнородных данных применяются методы фильтрации и оценки, такие как **фильтр Калмана**, позволяющие получить устойчивую и точную оценку ориентации во времени.
